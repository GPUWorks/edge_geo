...
void
message_callback_register(const std::function<bool(const SDL_Event &)> callback)
{
...
void
message_callback_unregister(const std::function<bool(const SDL_Event &)> &callback)
{
  std::lock_guard<std::mutex> locker(lock);
